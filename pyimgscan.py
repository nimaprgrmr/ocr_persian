...
def preprocess(img):
    ...
    img_edge = cv2.Canny(img_gray, 75, 200)
...
def getcorners(img_hull):
    ...
    try:
        ...
        return "the corners can't find in the image"

"""
Main Proccess of the Program
"""

def image_corrector(image_path):
    ...
    try:
        ...
        img_corrected = perspective_transform(img, corners)

        # write corrected image to file
        cv2.imwrite("./corrected.png", img_corrected)

    except:
        print("image is in correct perspective")
        # write corrected image to file
        cv2.imwrite("./corrected.png", img)


# how to use this program:
    #!python pyimgscan/pyimgscan.py -i pyimgscan/test/3.jpg


# img_path = "samples/kaj3.jpg"
# image_corrector(img_path)
